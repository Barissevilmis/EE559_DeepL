...
utils.plot_train_test(best_train_loss_fc, best_val_acc_fc,
                      best_train_acc_fc, "FC")
...
utils.plot_train_test(best_train_loss_cnn,
                      best_val_acc_cnn, best_train_acc_cnn, "CNN")
...
utils.plot_train_test(best_train_loss_auxn,
                      best_val_acc_auxn, best_train_acc_auxn, "AUXN")
